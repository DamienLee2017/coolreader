...
{  
     ...
     * 设置菜单子项的点击效果
     * @param index 子项的位置
     * @param colorSelBody  点击后的背景
     */
    public void setBodyClick(final int index,int colorSelBody)  
    {  
       ...
       handler1.postDelayed(new Runnable()
		{
			public void run()
			{
				 ((LinearLayout)gvBody.getChildAt(index)).setBackgroundColor(Color.TRANSPARENT);
			}
		}, 50);
       if(handler2==null)
