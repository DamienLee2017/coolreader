...
public class Constants {
	...
	public static final String BASE_IMAGE_URL = "http://fiction.icoolxue.com";
	...
	public static final String EXTRA_ID = "com.erakk.lnreader.id";
	public static final String EXTRA_SUMMARY = "com.erakk.lnreader.summary";
	...
	//小說類型id
	public static final String EXTRA_CATEGORY_ID="com.dotcool.category_id";
	public static final int EXTRA_HISTORY_CATEGORY_ID = 1;
	public static final int EXTRA_XUANHUAN_CATEGORY_ID = 3;
	public static final int EXTRA_KEHUAN_CATEGORY_ID = 7;
	public static final int EXTRA_QITA_CATEGORY_ID = 10;
	public static final int EXTRA_UPDATE_CATEGORY_ID = 11;
	public static final int EXTRA_MOOD_CATEGORY_ID = 12;
	...
	public static final int COLOR_UNREAD = Color.parseColor("#110d0d");
	...
	public static final String LANG_ENGLISH = "中文";

	/* You just need to add a new alternative language here and in AlternativeLanguageInfo -> initSingleton */
	public static final String[] languageList = { Constants.LANG_ENGLISH};
